...
sf = 30; 
iniPhase = 0; 
contrasts = [1, 2, 7, 13, 24, 46, 85]; % contrasts levels
...
figure();
plot(contrasts, energy_container(:, 1), 'o-', 'DisplayName','Mean of Normalized Up Energy', 'LineWidth', 2);  hold on;
plot(contrasts, energy_container(:, 2), 'o-', 'DisplayName','Mean of Normalized Down Energy', 'LineWidth', 2);  hold on;
plot(contrasts, energy_container(:, 3), 'o-', 'DisplayName','Mean of Normalized Left Energy', 'LineWidth', 2);  hold on;
plot(contrasts, energy_container(:, 4), 'o-', 'DisplayName','Mean of Normalized Right Energy', 'LineWidth', 2);  hold on;
